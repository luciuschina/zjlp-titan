...
@Service("MultiTitanDAOImpl")
public class MultiTitanDAOImpl extends TitanConPool implements ITitanDAO, Serializable {
    private static IEsDAO esDAO = new EsDAOImpl();

    private static final Logger LOGGER = LoggerFactory.getLogger(MultiTitanDAOImpl.class);
    ...
    public static void main(String[] args) {
        ...
        ITitanDAO d = new MultiTitanDAOImpl();

        d.getFriendsLevel("13100002001", new String[]{"1111"});
        d.getComFriendsNum("13100002001", new String[]{"1111"});
        d.getComFriendsNum("12300003333", new String[]{"1111"});
        d.getComFriendsNum("12300005555", new String[]{"1111"});
        d.getComFriendsNum("13000000001", new String[]{"1111"});
