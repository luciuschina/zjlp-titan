...
spark-submit --class com.zjlp.face.spark.base.CacheHotUser --driver-java-options -DPropPath=$SPARK_APP_HOME/config.properties --jars /opt/sparkApp/mysql-connector-java-5.1.22.jar  $SPARK_APP_HOME/zjlp-titan-1.0.jar